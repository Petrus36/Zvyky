      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16 max-w-5xl">
          <div className="mb-12 md:mb-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-6 font-inter">Kurz A</h1>
            <p className="text-lg md:text-xl text-gray-700 max-w-4xl leading-relaxed mb-8">
              Motocykel bez výkonového obmedzenia (35 kW a viac). Kurz pre tých, ktorí chcú jazdiť na výkonnejších motocykloch bez obmedzenia výkonu.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              ...
              <div className="bg-gradient-to-br from-zvyky-blue to-blue-600 rounded-2xl shadow-lg p-6 text-white">
                ...
                <div className="text-3xl md:text-4xl font-bold">{prices.malacky_A} €</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-12">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700 flex-1"><strong className="text-black">dosiahnutý vek 24 rokov</strong> (v čase skúšky)</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-zvyky-blue font-bold mt-1 text-xl">•</span>
                <span className="text-gray-700 flex-1"><strong className="text-black">absolvovanie vodičského kurzu skupiny A</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-zvyky-blue font-bold mt-1 text-xl">•</span>
          ...
          <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl shadow-lg p-6 md:p-8 mb-12">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              Pred skúškou je potrebné absolvovať aj kurz prvej pomoci.
            </p>
          </div>
          ...
          <div className="bg-yellow-50 border-2 border-yellow-200 rounded-2xl shadow-lg p-6 md:p-8 mb-12">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-4">
              Kolok nie je v cene a dopláca sa na konci kurzu. Pre A je to <strong className="text-black">25 €</strong>.
            </p>
